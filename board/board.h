...
#define BOARD_ENET_INT_IRQ			  GPIO1_Combined_0_15_IRQn
#define BOARD_ENET_INT_IRQ_HANDLER	  GPIO1_Combined_0_15_IRQHandler
...
#define BOARD_BT_UART_BASEADDR    LPUART6
#define BOARD_BT_UART_INSTANCE    6
#define BOARD_BT_UART_BAUDRATE    3000000
#define BOARD_BT_UART_CLK_FREQ    BOARD_DebugConsoleSrcFreq()
#define BOARD_BT_UART_IRQ         LPUART6_IRQn
#define BOARD_BT_UART_IRQ_HANDLER LPUART6_IRQHandler
