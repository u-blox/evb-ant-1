...
### EVB-ANT-1 Firmware
This open-source project is a basic firmware wirtten for the MCU of EVB-ANT-1, which is an NXP RT1062 
...
- On "Root Direcotry" select "ax_app_project_buildup" folder and press "next" and then "Finish"
...
- Build project and obtain .axf file.
- Set the dip switches on the evb to: 0-0-0-1 and then restrart the MCU. 
...
- Run NXP-MCUBootUtility.exe from the 'bin' folder of the repo
